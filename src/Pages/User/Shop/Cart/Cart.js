      ...
      <div className="container cart-page">
        {loading.current ? (
                    ...
                    return (
                      <tr className="itemRow" key={item.id}>
                        ...
                        <td className="product-name">
                          <Link to={`/shop/${item.id}`}>{itemD.title.en}</Link>
                        </td>
                        <td className="product-price">{itemD.price} $</td>
                        <td className="quantityBtns">
                          <button
                            className="btn btn-dark"
                            onClick={(e) => decreaseItemQuantity(item.id)}
                          >
                          ...
                          <button
                            className="btn btn-dark"
                            onClick={(e) => increaseItemQuantity(item.id)}
                          >
          ...
          <div className="emptyCart">
            Cart is empty. Go to <Link to="/shop">Store</Link>.
          </div>
        )}
      </div>
    );
